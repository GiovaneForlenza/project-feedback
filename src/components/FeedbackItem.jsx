    ...
    <div className="bg-white rounded-xl p-6 hover:shadow-lg transition-shadow cursor-pointer shadow-md">
      <div className="flex items-start gap-6">
        ...
        <div className="flex-1">
          <h3 className="font-bold text-lg text-gray-800 mb-1 hover:text-blue-600 transition-all">
            Suggestion Title
          </h3>
          <div className="text-gray-600 mb-3"> Suggestion Description</div>
          <span className="inline-block bg-blue-50 text-blue-500 px-4 py-1 rounded-lg text-sm font-semibold">
            Suggestion Category
          </span>
        </div>
