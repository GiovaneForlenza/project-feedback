      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="">
          ...
          <div className="space-y-4">
            <div className="bg-white rounded-xl p-6 border border-gray-200 cursor-pointer hover:shadow-sm transition-all hover:border-gray-300">
              <div className="mb-2">
              ...
              <span className="inline-block bg-blue-200 text-blue-700 px-4 py-1 rounded-lg text-sm font-semibold mb-4">
                Item Category
              </span>
